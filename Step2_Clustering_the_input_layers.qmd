...
# the following merges the values by their original coordinates to make sure each cell recieves the correct slope, bbpi and fbpi values
a<-merge(DF2, DF3, by=c("x","y"))
b<-merge(a, DF1, by=c("x","y"))
DF <- na.omit(data.frame(b$bbpi, b$fbpi, b$slope)) 
