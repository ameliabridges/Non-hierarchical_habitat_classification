...
DF_shuffle6= DF[sample(1:nrow(DF)), ]%>%
  select(bbpi, fbpi, slope)

DF_shuffle7= DF[sample(1:nrow(DF)), ]%>%
  select(bbpi, fbpi, slope)

DF_shuffle8= DF[sample(1:nrow(DF)), ]%>%
  select(bbpi, fbpi, slope)

DF_shuffle9= DF[sample(1:nrow(DF)), ]%>%
  select(bbpi, fbpi, slope)

DF_shuffle10= DF[sample(1:nrow(DF)), ]%>%
  select(bbpi, fbpi, slope)
