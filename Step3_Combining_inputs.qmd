...
topo_xyz<-as.data.frame(rasterToPoints(topo))%>%
  rename("topo_class"="Topography_4clusters_10km_WGS84")
prod_xyz<-as.data.frame(rasterToPoints(prod))%>%
  rename("prod_class"="Productivity_4clusters_10km_WGS84")
wms_xyz<-as.data.frame(rasterToPoints(wms))%>%
  rename("wms_class"="WaterMassStructure_3clusters_10km_WGS84")
