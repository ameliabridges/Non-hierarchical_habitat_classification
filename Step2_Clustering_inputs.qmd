...
In the event that you've closed your R & have lost the objects in the environment since running step 1, uncomment out these lines and read in your rasters. If you're continuing on from step 1 in the same R session, you don't need to run these. 
