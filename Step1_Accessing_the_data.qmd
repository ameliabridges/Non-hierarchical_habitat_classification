...
```{r}
terra::writeRaster(bbpi, filename=(paste0(input_layers_folder, "/GEBCO2020_BBPI_10km_MOL.tif")), overwrite=TRUE, format="GTiff")
```
...
```{r}
terra::writeRaster(fbpi, filename=(paste0(input_layers_folder, "/GEBCO2020_FBPI_10km_MOL.tif")), overwrite=TRUE, format="GTiff")
```
